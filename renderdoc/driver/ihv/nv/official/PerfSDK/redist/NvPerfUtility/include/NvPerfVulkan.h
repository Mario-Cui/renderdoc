...
struct VulkanFunctions
{
  ...
  void Initialize(VkInstance instance, VkDevice device,
                  PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr_,
                  PFN_vkGetDeviceProcAddr pfnVkGetDeviceProcAddr_)
  {
    ...
    if(pfnVkGetInstanceProcAddr)
    {
      pfnVkGetPhysicalDeviceMemoryProperties =
          (PFN_vkGetPhysicalDeviceMemoryProperties)pfnVkGetInstanceProcAddr(
              instance, "vkGetPhysicalDeviceMemoryProperties");
      pfnVkGetPhysicalDeviceProperties = (PFN_vkGetPhysicalDeviceProperties)pfnVkGetInstanceProcAddr(
    ...
    if(pfnVkGetDeviceProcAddr)
    {
      pfnVkAllocateCommandBuffers =
          (PFN_vkAllocateCommandBuffers)pfnVkGetDeviceProcAddr(device, "vkAllocateCommandBuffers");
      pfnVkAllocateMemory =
          (PFN_vkAllocateMemory)pfnVkGetDeviceProcAddr(device, "vkAllocateMemory");
      pfnVkBeginCommandBuffer =
          (PFN_vkBeginCommandBuffer)pfnVkGetDeviceProcAddr(device, "vkBeginCommandBuffer");
      pfnVkBindBufferMemory =
          (PFN_vkBindBufferMemory)pfnVkGetDeviceProcAddr(device, "vkBindBufferMemory");
      pfnVkCreateBuffer = (PFN_vkCreateBuffer)pfnVkGetDeviceProcAddr(device, "vkCreateBuffer");
      pfnVkCreateCommandPool =
          (PFN_vkCreateCommandPool)pfnVkGetDeviceProcAddr(device, "vkCreateCommandPool");
      ...
      pfnVkDestroyCommandPool =
          (PFN_vkDestroyCommandPool)pfnVkGetDeviceProcAddr(device, "vkDestroyCommandPool");
      pfnVkDestroyFence = (PFN_vkDestroyFence)pfnVkGetDeviceProcAddr(device, "vkDestroyFence");
      pfnVkEndCommandBuffer =
          (PFN_vkEndCommandBuffer)pfnVkGetDeviceProcAddr(device, "vkEndCommandBuffer");
      pfnVkFreeCommandBuffers =
          (PFN_vkFreeCommandBuffers)pfnVkGetDeviceProcAddr(device, "vkFreeCommandBuffers");
      pfnVkFreeMemory = (PFN_vkFreeMemory)pfnVkGetDeviceProcAddr(device, "vkFreeMemory");
      pfnVkGetBufferMemoryRequirements = (PFN_vkGetBufferMemoryRequirements)pfnVkGetDeviceProcAddr(
          device, "vkGetBufferMemoryRequirements");
      pfnVkGetFenceStatus =
          (PFN_vkGetFenceStatus)pfnVkGetDeviceProcAddr(device, "vkGetFenceStatus");
      ...
      pfnVkResetCommandBuffer =
          (PFN_vkResetCommandBuffer)pfnVkGetDeviceProcAddr(device, "vkResetCommandBuffer");
      ...
      pfnVkCreateQueryPool =
          (PFN_vkCreateQueryPool)pfnVkGetDeviceProcAddr(device, "vkCreateQueryPool");
      pfnVkDestroyQueryPool =
          (PFN_vkDestroyQueryPool)pfnVkGetDeviceProcAddr(device, "vkDestroyQueryPool");
      pfnVkCmdWriteTimestamp =
          (PFN_vkCmdWriteTimestamp)pfnVkGetDeviceProcAddr(device, "vkCmdWriteTimestamp");
      pfnVkCmdResetQueryPool =
          (PFN_vkCmdResetQueryPool)pfnVkGetDeviceProcAddr(device, "vkCmdResetQueryPool");
      pfnVkGetQueryPoolResults =
          (PFN_vkGetQueryPoolResults)pfnVkGetDeviceProcAddr(device, "vkGetQueryPoolResults");
    }
  }
#else
  void Initialize()
...
)
{
  PFN_vkGetPhysicalDeviceProperties pfnVkGetPhysicalDeviceProperties =
#if defined(VK_NO_PROTOTYPES)
      (PFN_vkGetPhysicalDeviceProperties)pfnVkGetInstanceProcAddr(instance,
...
#if defined(VK_NO_PROTOTYPES)
                                 ,
                                 VkInstance instance, PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr
#endif
)
{
  PFN_vkGetPhysicalDeviceProperties pfnVkGetPhysicalDeviceProperties =
...
#endif
  PFN_vkEnumerateInstanceVersion pfnVkEnumerateInstanceVersion =
      (PFN_vkEnumerateInstanceVersion)pfnVkGetInstanceProcAddr(VK_NULL_HANDLE,
...
inline bool VulkanAppendInstanceRequiredExtensions(std::vector<const char *> &instanceExtensionNames,
                                                   uint32_t apiVersion)
{
  NVPW_VK_Profiler_GetRequiredInstanceExtensions_Params getRequiredInstanceExtensionsParams = {
      NVPW_VK_Profiler_GetRequiredInstanceExtensions_Params_STRUCT_SIZE};
  getRequiredInstanceExtensionsParams.apiVersion = apiVersion;

  NVPA_Status nvpaStatus =
      NVPW_VK_Profiler_GetRequiredInstanceExtensions(&getRequiredInstanceExtensionsParams);
  if(nvpaStatus)
  {
  ...
  if(!getRequiredInstanceExtensionsParams.isOfficiallySupportedVersion)
  {
    ...
    NV_PERF_LOG_WRN(
        10, "Vulkan Instance API Version: %u.%u.%u - is not an officially supported version\n",
        major, minor, patch);
  }

  for(uint32_t extensionIndex = 0;
      extensionIndex < getRequiredInstanceExtensionsParams.numInstanceExtensionNames;
      ++extensionIndex)
  {
    instanceExtensionNames.push_back(
        getRequiredInstanceExtensionsParams.ppInstanceExtensionNames[extensionIndex]);
  }
  return true;
}

inline bool VulkanAppendDeviceRequiredExtensions(VkInstance instance, VkPhysicalDevice physicalDevice,
                                                 void *pfnVkGetInstanceProcAddr,
                                                 std::vector<const char *> &deviceExtensionNames)
{
  if(!VulkanIsNvidiaDevice(physicalDevice
#if defined(VK_NO_PROTOTYPES)
                           ,
                           instance, (PFN_vkGetInstanceProcAddr)pfnVkGetInstanceProcAddr
#endif
                           ))
  {
  ...
  NVPW_VK_Profiler_GetRequiredDeviceExtensions_Params getRequiredDeviceExtensionsParams = {
      NVPW_VK_Profiler_GetRequiredDeviceExtensions_Params_STRUCT_SIZE};
  getRequiredDeviceExtensionsParams.apiVersion = VulkanGetPhysicalDeviceApiVersion(
      physicalDevice
#if defined(VK_NO_PROTOTYPES)
      ,
      instance, reinterpret_cast<PFN_vkGetInstanceProcAddr>(pfnVkGetInstanceProcAddr)
#endif
  );
  ...
  NVPA_Status nvpaStatus =
      NVPW_VK_Profiler_GetRequiredDeviceExtensions(&getRequiredDeviceExtensionsParams);
  if(nvpaStatus)
  {
  ...
  if(!getRequiredDeviceExtensionsParams.isOfficiallySupportedVersion)
  {
    ...
    //                Unknown version warnings should be reported back to the Nsight Perf team to get official support
    NV_PERF_LOG_WRN(
        100, "Vulkan Device API Version: %u.%u.%u - is not an officially supported version\n",
        major, minor, patch);
  }

  for(uint32_t extensionIndex = 0;
      extensionIndex < getRequiredDeviceExtensionsParams.numDeviceExtensionNames; ++extensionIndex)
  {
    deviceExtensionNames.push_back(
        getRequiredDeviceExtensionsParams.ppDeviceExtensionNames[extensionIndex]);
  }

  return true;
}

inline bool VulkanAppendRequiredExtensions(std::vector<const char *> &instanceExtensionNames,
                                           std::vector<const char *> &deviceExtensionNames,
                                           uint32_t apiVersion, VkInstance instance = VK_NULL_HANDLE,
                                           ...
                                           PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr = nullptr)
{
  ...
  status = VulkanAppendDeviceRequiredExtensions(
      instance, physicalDevice, (void *)pfnVkGetInstanceProcAddr, deviceExtensionNames);
  if(!status)
  {
    return false;
  }
...
inline size_t VulkanGetNvperfDeviceIndex(VkInstance instance, VkPhysicalDevice physicalDevice,
                                         VkDevice device
#if defined(VK_NO_PROTOTYPES)
                                         ,
                                         PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr,
                                         ...
                                         size_t sliIndex = 0)
{
  NVPW_VK_Device_GetDeviceIndex_Params getDeviceIndexParams = {
      NVPW_VK_Device_GetDeviceIndex_Params_STRUCT_SIZE};
...
inline DeviceIdentifiers VulkanGetDeviceIdentifiers(VkInstance instance,
                                                    ...
                                                    size_t sliIndex = 0)
{
  const size_t deviceIndex =
      VulkanGetNvperfDeviceIndex(instance, physicalDevice, device
#if defined(VK_NO_PROTOTYPES)
                                 ,
                                 pfnVkGetInstanceProcAddr, pfnVkGetDeviceProcAddr
#endif
                                 ,
                                 sliIndex);
...
inline NVPW_Device_ClockStatus VulkanGetDeviceClockState(
    VkInstance instance, VkPhysicalDevice physicalDevice, VkDevice device
#if defined(VK_NO_PROTOTYPES)
    ,
    PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr, PFN_vkGetDeviceProcAddr pfnVkGetDeviceProcAddr
#endif
)
{
  size_t nvperfDeviceIndex =
      VulkanGetNvperfDeviceIndex(instance, physicalDevice, device
#if defined(VK_NO_PROTOTYPES)
                                 ,
                                 pfnVkGetInstanceProcAddr, pfnVkGetDeviceProcAddr
...
inline bool VulkanSetDeviceClockState(VkInstance instance, VkPhysicalDevice physicalDevice,
                                      VkDevice device, NVPW_Device_ClockSetting clockStatus
#if defined(VK_NO_PROTOTYPES)
                                      ,
                                      PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr,
                                      PFN_vkGetDeviceProcAddr pfnVkGetDeviceProcAddr
...
inline bool VulkanSetDeviceClockState(VkInstance instance, VkPhysicalDevice physicalDevice,
                                      VkDevice device, NVPW_Device_ClockStatus clockStatus
#if defined(VK_NO_PROTOTYPES)
                                      ,
                                      PFN_vkGetInstanceProcAddr pfnVkGetInstanceProcAddr,
                                      PFN_vkGetDeviceProcAddr pfnVkGetDeviceProcAddr
...
{
  NVPW_VK_MetricsEvaluator_CalculateScratchBufferSize_Params calculateScratchBufferSizeParams = {
      NVPW_VK_MetricsEvaluator_CalculateScratchBufferSize_Params_STRUCT_SIZE};
  calculateScratchBufferSizeParams.pChipName = pChipName;
  NVPA_Status nvpaStatus =
      NVPW_VK_MetricsEvaluator_CalculateScratchBufferSize(&calculateScratchBufferSizeParams);
  if(nvpaStatus)
  {
    NV_PERF_LOG_ERR(20,
                    "NVPW_VK_MetricsEvaluator_CalculateScratchBufferSize failed, nvpaStatus = %s\n",
                    FormatStatus(nvpaStatus).c_str());
    return 0;
  }
...
inline NVPW_MetricsEvaluator *VulkanCreateMetricsEvaluator(uint8_t *pScratchBuffer,
                                                           size_t scratchBufferSize,
                                                           const char *pChipName)
{
  NVPW_VK_MetricsEvaluator_Initialize_Params initializeParams = {
      NVPW_VK_MetricsEvaluator_Initialize_Params_STRUCT_SIZE};
...
{
  NVPW_VK_RawMetricsConfig_Create_Params configParams = {
      NVPW_VK_RawMetricsConfig_Create_Params_STRUCT_SIZE};
...
#if defined(VK_NO_PROTOTYPES)
                                                 ,
                                                 instance, pfnVkGetInstanceProcAddr
#endif
    );
  ...
  if(!params.isSupported)
  {
    ...
    if(params.gpuArchitectureSupportLevel != NVPW_GPU_ARCHITECTURE_SUPPORT_LEVEL_SUPPORTED)
    {
      const DeviceIdentifiers deviceIdentifiers =
          VulkanGetDeviceIdentifiers(instance, physicalDevice, device
#if defined(VK_NO_PROTOTYPES)
                                     ,
                                     pfnVkGetInstanceProcAddr, pfnVkGetDeviceProcAddr
#endif
...
{
  NVPW_VK_Profiler_CommandBuffer_PushRange_Params pushRangeParams = {
      NVPW_VK_Profiler_CommandBuffer_PushRange_Params_STRUCT_SIZE};
...
{
  NVPW_VK_Profiler_CommandBuffer_PopRange_Params popParams = {
      NVPW_VK_Profiler_CommandBuffer_PopRange_Params_STRUCT_SIZE};
...
public:
  VulkanRangeCommands()
      : isNvidiaDevice(false), PushRange(&VulkanPushRange_Nop), PopRange(&VulkanPopRange_Nop)
  {
  }
                                 ...
                                 size_t sliIndex = 0)
{
  ...
  NVPW_VK_MiniTrace_IsGpuSupported_Params params = {
      NVPW_VK_MiniTrace_IsGpuSupported_Params_STRUCT_SIZE};
  params.deviceIndex = deviceIndex;
